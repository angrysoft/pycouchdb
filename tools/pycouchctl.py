...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--url', action='store_const', const='url', dest='url', help='url sever')
    parser.add_argument('-d', '--dump', nargs='+' , action=DumpAction, help="Dump database to json file")
    parser.add_argument('-r', '--restore', nargs='+' , action=RestoreAction, help="Restore database from json file")
    
    args = parser.parse_args()
    for db_name in args.dbs:
        dump(db_name, url=args.url)